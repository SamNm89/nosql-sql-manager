...
📦 **[Download v0.0 Release](https://github.com/SamNm89/nosql-sql-manager/releases/tag/v0.0)**

Extract and run `BankingApp.exe` - no Python installation required!

### Option 2: Using the Batch File (Development)
```bash
